#!/bin/bash
# Run hello_simeng with a64fx config
...
echo "Starting hello_simeng simulation with a64fx..."
$SIMENG_EXE $CONFIG $GEEKBENCH_BIN > /workspace/SimEng/test_hello_a64fx.log 2>&1
echo "Finished. Check /workspace/SimEng/test_hello_a64fx.log"
